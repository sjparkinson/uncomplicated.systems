    ...
    <div class="o-grid-container">
        <div class="o-grid-row">
            <div data-o-grid-colspan="one-third center">
                ...
                <p><img src="/assets/images/b54462c6-95b6-40bf-9c9f-a28968d3a8f9.svg"></p>
            </div>
        </div>
    </div>
...
> ➡️ Find the next post in this series at [Docker 110 – Dockerfiles & Volumes 🐳](/2018/06/05/docker-0110-dockerfiles-and-volumes).
